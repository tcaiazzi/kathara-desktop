...
export function openTerminalWindow(labId: string, machineName: string): void {
  const url = `/labs/${encodeURIComponent(labId)}/terminal/${encodeURIComponent(machineName)}`;
